...
const Calculator = () => {
  ...
  const calculateResult = () => {
    if (lastInput !== '' && newInput !== '') {
      ...
      const num2 = parseFloat(newInput);

      switch (operation) {
        case '+':
          setNewInput((num1 + num2).toString());
          break;
        case '-':
          setNewInput((num1 - num2).toString());
          break;
